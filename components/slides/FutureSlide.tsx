...
export default function FutureSlide() {
  const timelineSteps = [
    { year: '2025', phase: 'CIRO Core', description: 'Data connectivity & problem detection', color: 'orange' },
    { year: '2026', phase: 'Overlay', description: 'Insight into physical space', color: 'blue' },
    { year: '2027', phase: 'Robotics', description: 'Autonomous robots with CIRO agents', color: 'purple' },
    { year: '2028', phase: 'Global Edge Mesh', description: 'Network of edge intelligence nodes', color: 'pink' }
  ]
    ...
    <div className="slide-container">
      <div className="slide-content py-4">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <blockquote className="text-lg text-gray-200 italic leading-relaxed mb-4">
                "CIRO isn't just software. It's infrastructure for the next industrial leap."
              </blockquote>
              ...
              <div className="grid grid-cols-3 gap-3 mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-gray-300">Industrial assistants</p>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <p className="text-sm text-gray-300">Autonomous robots</p>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                  <p className="text-sm text-gray-300">Edge intelligence</p>
                </div>
              </div>
        ...
        <div className="relative">
          <h2 className="text-2xl font-bold text-white mb-6 text-center">Our Roadmap</h2>
        ...
        <div className="text-center mt-6">
          <div className="inline-block bg-gradient-to-r from-orange-500 to-red-600 text-white px-6 py-2 rounded-lg font-bold text-sm shadow-lg">
            Building Tomorrow's Industrial Intelligence
          </div>
        </div>
      </div>
    </div>
